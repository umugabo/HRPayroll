...
include 'functions.php';
	  ...
	  // connections
		  ...
		  $password=$_POST['password'];
		   ...
		   $query="UPDATE employee SET username='$username', password='$password', status='$st' WHERE empl_id=".$_POST['imp_id'];
...
<table>
	...
	<td><input title="code" type="text" accesskey="1" value="<?php echo $code ?>" disabled  placeholder="Employee Code"/></td>
				...
				<tr>
                   ...
                   <td><input title="Name" type="text" accesskey="1" name="lname" disabled value="<?php echo $lname?>" class='requiredx' required placeholder='Last Name'/></td>
				   </tr>

				 <tr>
                   <td><span class="style2"><FONT size='3'  COLOR="">Email</em></span></td>
                   <td><input title="Name" type="text" accesskey="1" name="Email" disabled value="<?php echo $email?>" class='requiredx' required placeholder='Email'/></td>
                </tr>
				 <tr>
                   <td><span class="style2"><FONT size='3'  COLOR="">Phone Number:</em></span></td>
                   <td><input title="Phone" type="int" accesskey="1"  name="phone" disabled value="<?php echo $phone?>" required  placeholder='Phone Number'/></td>
                </tr>
				 ...
				 <tr>
                   ...
                   <td><input title="Name" type="text" accesskey="1" name="password"  class='requiredx' required placeholder='Password'/></td>
				    ...
				    <tr>
                   <td><span class="style2"><FONT size='3'  COLOR="3"><font color="white">Usertype:</font></em></span></td>
                   <td><select>
				   <option>Admin</option>
