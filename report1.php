...
<form method="post">
birth date<input type="checkbox" name="bd">
gender<input type="checkbox" name="gender">
mstatus<input type="checkbox" name="mstatus">
phone<input type="checkbox" name="phone">
email<input type="checkbox" name="email">
qualification<input type="checkbox" name="qualif">
starting date<input type="checkbox" name="startd">
ending date<input type="checkbox" name="endd">
nationality<input type="checkbox" name="nationality">
place birth<input type="checkbox" name="pbirth">
place residance<input type="checkbox" name="presidance">
position<input type="checkbox" name="position">
father name<input type="checkbox" name="father_name">
mother name<input type="checkbox" name="mother_name">
number of child<input type="checkbox" name="nchild">
insurance<input type="checkbox" name="insurance">
emargency number<input type="checkbox" name="em_number">
emargency name<input type="checkbox" name="em_name">
username<input type="checkbox" name="username">

<br>
<input type="submit" value="generate report" name="gene">
</form>
...
<td>".$username."</td>
		...
		$result = mysqli_query($conn, "SELECT * FROM `employee` INNER JOIN positions ON positions.post_id=employee.position INNER JOIN qualifications ON qualifications.qual_id=employee.qualification");
