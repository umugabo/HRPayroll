...
<TR>
 ...
 <form action="search1.php" method="POST">
         <table style="font-style: italic;margin:auto;border:1px solid #000; width:500px; height:200px; border-radius:10px 110px 10px 100px ; color:grey; background-color: green;   ">
                 <tr>
...
while($row = mysqli_fetch_array($result))
{
 ...
 ?>
				   ...
				   <td align="center" width="20"><a rel='facebox'  href="admupdate1.php?pass=<?php echo $row['empl_id']?>"   title="Click To Edit"><IMG SRC="photo/edit.png" WIDTH="50" HEIGHT="25" BORDER="0" ALT=""></a></td>
