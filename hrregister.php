...
<tr>
       ...
       <tr>
	    ...
	    <tr>
                   <td><span class="style2"><FONT size='3'  COLOR="">Browse ID</em></span></td>
                   <td><input title="idcard" type="file" accesskey="1" name="idPhoto"  class='requiredx' size="16" placeholder='ID Number' value=""/></td>
      </tr>
	  <tr>
...
<A HREF="#" onClick=" window.dateField=document.ds_conclass.value; calendar = window.open('w01pkg.call_cal','cal', 'WIDTH=250,HEIGHT=250'); return false"></A>
      ...
      <tr>
                    ...
                    <td height="27">Marital status:</span></td>
                  
                    <td height="33"><label>
                      <select name="mstatus" id="fu">
...
<tr>
				...
				<tr>
                   <td><span class="style2"><FONT size='3'  COLOR="">Place of Birth</em></span></td>
                   <td><input title="Name" type="text" accesskey="1" name="Place_Birth"   placeholder='Place of Birth'/></td>
				   </tr>
				<tr>
...
<td>
<input type="text" name="bankno"  required placeholder="Account number" />
</TD>
</TR>
...
<td>
<textarea name="Health_Condition"   placeholder="Summarize your Condition"></textarea>

</TD>
</TR>

<tr><td colspan="2"><B>Enter someone's name to call incase of emergency</B></td></tr>
<TR VALIGN="TOP">
<TD ><B>Emergency Name: </B></TD>
<TD ALIGN="LEFT">

<input type="text" name="Em_Name"  required placeholder="Name"/>
...
<input type="text" name="Em_Number"  required placeholder="Phone"/>
