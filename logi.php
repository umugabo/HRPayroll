...
<body>
<form action="logi.php" method="post" name="login" >
...
$check = mysqli_query($conn, "SELECT * FROM employee WHERE username = '$username' and password='$password' and user_type=2");
...
if ($check2 == 0) 
{
 echo '<b><font color="red">You entered Wrong UserName or Password!</font></b><br><a href=logi.php>Wrong UserName.</a><br>';
} 
else  if ($password != $password)
{
echo '<font color="red"><b> Incorrect password! <br><a href=logi.php> Wrong Password.</a><br></b></font>';
}
else
{
...
echo "<META http-equiv=refresh content=1;URL=hr.php>";
...
<body bgcolor="#99D5D3">
 <form name='logi' method='post' action='login.php'/>
           <table style="font-style: italic;margin:auto;border:1px solid #000; width:800px; height:200px; border-radius:90px 90px 90px 90px ; color:red; background-color: green;   ">
                 <tr>
                  <td height="21" colspan="2" align='center'><h3>HR Pane</td>
                 </tr>
                <tr>
