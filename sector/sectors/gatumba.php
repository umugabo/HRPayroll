...
<body><div style="border:2px solid black;height:auto;width:1350px;">
...
<div class="container"style="border:px solid black;margin:0px;padding:2px;margin-top:0px;width:180px;position:absolute">
<nav>
		<ul class="menu">
			<li>
...
$row=mysql_fetch_array($sql)){
  echo "<tr>
    ...
    <td>".$row['lfn']."<br>".$row['lln']."<br>".$row['post']."<br><br><b>on&nbsp&nbsp".$row['date']."</b></td>
