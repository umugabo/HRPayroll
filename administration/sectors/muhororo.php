...
<div class="container"style="margin:-2px;padding:2px;margin-top:-1px;width:180px;position:absolute">
<nav>
		<ul class="menu">
			<li>
...
<table width="1157" height="209" border="1">
  ...
  $con=mysql_connect('localhost','root','');
mysql_select_db("dbtest",$con);
$sql=mysql_query("select * from sectorquestion where usec='muhororo' order by id DESC");
$i=1;
while (
$row=mysql_fetch_array($sql)){
  echo "<tr>
    ...
    <td>".$row['lfn']."<br>".$row['lln']."<br>".$row['post']."<br>".$row['depart']."<br><b>on&nbsp&nbsp".$row['date']."</b></td>
