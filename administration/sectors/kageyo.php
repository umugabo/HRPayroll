...
<body>
	...
	<div style="height:auto;width:1350px;margin-left:-1px;margin-top:-3px;;background-image:url(../photos/background.jpg);">
	<div style="height:160px;width:1350px;background-image:url(../photos/banner3.jpg);margin-top:0px">
		</div>

<div class="container"style="border:0px solid black;margin:-3px;padding:2px;margin-top:-2px;width:180px;position:absolute">
<nav>
		<ul class="menu">
			<li>
...
<div style="height:auto;width:1160px;margin-left:180px;background: #FFF;border-radius:15px;padding-left:10px;">
...
<table width="1157" height="209" border="1">
  ...
  $con=mysql_connect('localhost','root','');
mysql_select_db("dbtest",$con);
$sql=mysql_query("select * from sectorquestion where usec='kageyo' order by id DESC");
$i=1;
while (
