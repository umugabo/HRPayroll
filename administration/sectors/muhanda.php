...
<link rel="icon" type="image/jpg" href="../photos/iconn.png" />
<link rel="stylesheet" href="../styles/search.css">
    <link rel="stylesheet" href="2.css">
    <title>muhanda sector</title>
</head>
<?php
...
<div class="container"style="margin:-1.5px;padding:2px;margin-top:-1px;width:180px;position:absolute">
<nav>
		<ul class="menu">
			<li>
...
$row=mysql_fetch_array($sql)){
  echo "<tr>
    ...
    <td>".$row['lfn']."&nbsp;".$row['lln']."<br>".$row['post']."<br>".$row['depart']."<br><b>on&nbsp&nbsp".$row['date']."</b></td>
