...
<body>
	...
	<div style="border:0px solid black;height:auto;width:1350px;margin-left:-1px;margin-top:-3px;margin-top:-3px;background-image:url(../photos/background.jpg);">
...
<table width="1157" height="209" border="1">
  ...
  $con=mysql_connect('localhost','root','');
mysql_select_db("dbtest",$con);
$sql=mysql_query("select * from sectorquestion where usec='ndaro' order by id DESC");
$i=1;
while (
