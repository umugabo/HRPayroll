...
<body>
	...
	<div style="border:0px solid black;padding-left:3px;height:auto;width:1360px;margin-left:-1px;margin-top:-3px;background-image:url(../photos/background.jpg);">
	<div style="border:0px solid black;height:160px;width:1360px;margin-top:0px;background-image:url(../photos/banner3.jpg);">
</div>

<div class="container"style="margin:0px;padding:2px;margin-left:-6npx;width:180px;position:absolute;padding-left:-45px;">
<nav>
		<ul class="menu">
			<li>
...
<div style="height:70px;width:35.88%;margin-left:180px;background-color:#2565a7;float:left;border-radius:1px;font-size:20px;margin-top:0px;padding-left:12px;">
...
<div style="height:70px;width:50%;background-color:#2565a7;float:right;border-radius:1px;font-size:20px;padding-left:-10px;margin-top:0px">

<div ><a href="../account.php">
<?php
echo '<img src="data:image/jpeg;base64,'.base64_encode( $userRow['image'] ).'"style="width:20px;padding-left:3px;height:30px;border-radius:50%;height: 80px;margin-top: -7px;width:80px;float:right;"/>';?>
</a>
</div>
	</div>
<A HREF="download.php">
<img src="../photos/google.png"width="153"height="78"style="float:right;position:fixed;margin-top:20%;margin-left:39%"></A>
<div style="border:0px solid blue;height:auto;width:1167px;margin-left:190px;margin-top:0px;background: #FFF;border-radius:15px;">
<table width="1157" height="209" border="1">
  ...
  $con=mysql_connect('localhost','root','');
mysql_select_db("dbtest",$con);
$sql=mysql_query("select * from sectorquestion where usec='hindiro' order by id DESC");
$i=1;
while (
