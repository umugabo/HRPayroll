...
<body>
	...
	<div style="border:0px solid black;padding-left:2px;height:auto;width:1350px;margin-left:-1px;margin-top:-3px;background-image:url(../photos/background.jpg);">
	<div style="border:0px solid black;height:160px;width:1350px;background-image:url(../photos/banner3.jpg);margin-top:0px">
</div>

<div class="container"style="border:0px solid black;margin:-4px;px;padding:2px;margin-top:0px;width:180px;position:absolute">
<nav>
		<ul class="menu">
			<li>
...
<table width="1157" height="209" border="1">
  ...
  $con=mysql_connect('localhost','root','');
mysql_select_db("dbtest",$con);
$sql=mysql_query("select * from sectorquestion where usec='kabaya' order by id DESC");
$i=1;
while (
