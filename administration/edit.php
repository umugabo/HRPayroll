...
if(isset($_GET['id']))
{
  ...
  $nb=$_POST['nb'];
  $updated=mysql_query("UPDATE question SET 
...
<?php 
  ...
  {
  $id=$_GET['id'];
  $getselect=mysql_query("SELECT * FROM question WHERE id='$id'");
...
<input type="text" name="f_name" placeholder="first name"class="ed"value="<?php echo $profile[ufn]; ?>" required />
