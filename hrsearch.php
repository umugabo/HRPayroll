...
<TR>
 ...
 <form action="hrsearch.php" method="POST">
...
echo '<center><table cellpadding="0" bgcolor="" cellspacing="0" id="resultTable" border="1"><font clor=" yellow"><thead><tr class="record"><th>Empl Id</th><th>First Name</th><th>Last Name</th><th>Phone</th><th>Gender</th><th>Action</th></tr></thead></font></center>';
$count=0;
// printing table rows
while($row = mysqli_fetch_array($result))
{
 ...
 ?>
				   ...
				   <td align="center" width="20"><a rel='facebox'  href="salaryupdate.php?pass=<?php echo $row['empl_id']?>"   title="Click To Edit"><IMG SRC="photo/edit.png" WIDTH="50" HEIGHT="25" BORDER="0" ALT=""></a></td>
