...
$check = mysqli_query($conn, "SELECT * FROM employee where username = '$username'and password='$password' and user_type=3")or die(mysqli_error());
...
if ($check2 == 0) 
{
 echo '<b><font color="red">You entered Wrong UserName or Password!</font></b><br><a href=log.php>Wrong UserName.</a><br>';
} 
else  if ($password != $password)
{
echo '<font color="red"><b> Incorrect password! <br><a href=log.php> Wrong Password.</a><br></b></font>';
}
else
{
...
<body bgcolor="#99D5D3">
 <form name='login' method='post' action='login.php'/>
           <table style="font-style: italic;margin:auto;border:1px solid #000; width:800px; height:200px; border-radius:90px 90px 90px 90px ; color:red; background-color: green;   ">
                 <tr>
                   <td height="21" colspan="2" align='center'><h3>Employee Pane</td>
                 </tr>
                <tr>
